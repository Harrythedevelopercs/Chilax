...
const bakeryHighlights = [
  {
    title: "Custom Cake & Pastry Boxes",
    subtitle: "Side Lock & 6-Corner Boxes",
    image: "/bakery/bakery_cake_boxes.png",
    tag: "Food Grade",
    description: "Sturdy grease-resistant cake boxes engineered with pop-up corners and side-locking tabs for safe transport.",
  },
  {
    title: "Gable & Handle Carriers",
    subtitle: "Cube Carriers & Handle Boxes",
    image: "/bakery/bakery_gable_carriers.png",
    tag: "Easy Carry",
    description: "Convenient gable boxes and cube carriers with built-in handles designed for bakery takeaways & party favors.",
  },
  {
    title: "Food-Safe Paper Bags & Pouches",
    subtitle: "SOS Bags & Window Bread Bags",
    image: "/bakery/bakery_paper_bags.png",
    tag: "Eco Friendly",
    description: "Greaseproof kraft paper bags and clear-window pouches crafted for fresh loaves, baguettes, and pastries.",
  },
  {
    title: "Custom Bakery Stickers & Labels",
    subtitle: "Foil Stamped & Die-Cut Labels",
    image: "/bakery/bakery_labels_stickers.png",
    tag: "Oil & Moisture Proof",
    description: "Custom printed sheet labels and branding stickers designed to securely seal bakery boxes and bag closure tags.",
  },
];

export default function BakeryShowcaseBanner() {
  return (
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider bg-[#277a4e]/10 text-[#277a4e] mb-3">
              ...
              BAKERY PACKAGING RANGE
            </span>
            <h2 className="font-poppins text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#0f172a] tracking-tight leading-tight">
              Packaging Built Specifically for Bakeries & Pastry Shops
            </h2>
            <p className="text-gray-600 text-sm sm:text-base mt-2 leading-relaxed">
              Explore food-safe bakery packaging styles crafted to keep cakes fresh, facilitate easy carrying, and present your baked creations beautifully.
            </p>
          </div>
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 p-4 sm:p-6 bg-white rounded-2xl border border-gray-200/80 shadow-2xs">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500">Ideal for small & large bakeries</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#0f172a]">100% Food-Safe & Recyclable</h4>
              <p className="text-[11px] text-gray-500">FDA approved materials</p>
            </div>
          </div>
        </div>
