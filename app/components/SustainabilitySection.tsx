        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden shadow-lg border border-gray-100 min-h-[380px] md:min-h-[460px] w-full group">
            ...
            <div className="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md p-4 rounded-2xl border border-white/40 shadow-sm flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-[#eaf6f0] flex items-center justify-center text-[#277a4e] flex-shrink-0">
          ...
          <div className="flex flex-col items-start justify-center">
            ...
            {/* Pill Badge */}
            <span className="inline-block font-poppins text-[11px] font-bold tracking-wider uppercase text-[#277a4e] bg-[#eaf6f0] px-4 py-1.5 rounded-full mb-4">
            ...
            <ul className="space-y-3 mb-8 w-full">
              <li className="flex items-center gap-3 text-sm text-gray-700 font-medium">
                <span className="w-5 h-5 rounded-full bg-[#eaf6f0] flex items-center justify-center flex-shrink-0 text-[#277a4e]">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Link
                href="/catalog"
                className="font-poppins bg-[#277a4e] hover:bg-[#1d5338] text-white px-6 py-3 rounded-xl text-sm font-bold shadow-sm transition-all duration-200"
              >
                Browse products
              </Link>
              <Link
                href="/contact"
                className="font-poppins bg-white hover:bg-gray-50 text-[#277a4e] border border-[#277a4e] px-6 py-3 rounded-xl text-sm font-bold transition-all duration-200"
              >
                Learn how we do it
              </Link>
            </div>
