        ...
        <div className="max-w-xl text-white">
          ...
          <form onSubmit={handleSearch} className="mb-7 w-full max-w-xl">
            <div className="relative flex items-center bg-white rounded-xl sm:rounded-2xl p-1.5 shadow-lg border border-white/20">
              ...
              <button
                type="submit"
                style={{ backgroundColor: '#277a4e', color: '#ffffff' }}
                className="bg-[#277a4e] hover:bg-[#1d5338] text-white px-6 sm:px-7 py-2.5 sm:py-3 rounded-lg sm:rounded-xl text-sm sm:text-base font-semibold transition-colors shrink-0 shadow-xs cursor-pointer"
              >
                Search
              </button>
            </div>
          ...
          <div className="flex flex-row items-center gap-2 sm:gap-3.5 w-full max-w-md">
            <Link
              href="#quote"
              className="flex-1 text-center whitespace-nowrap bg-[#277a4e] hover:bg-[#1d5338] text-white px-3.5 sm:px-6 py-2.5 sm:py-3 rounded-lg text-xs sm:text-base font-bold shadow-sm transition-colors"
            >
              Request a Quote
            </Link>
            <Link
        ...
        <div className="container mx-auto flex flex-wrap items-center justify-between gap-4 text-xs">
          ...
          <div className="flex items-center gap-2 text-gray-800 flex-wrap">
            ...
            <div className="flex items-center gap-0.5 ml-1">
              {[1, 2, 3, 4, 5].map((i) => (
                <svg key={i} className="w-3.5 h-3.5 text-[#277a4e] fill-[#277a4e]" viewBox="0 0 20 20">
