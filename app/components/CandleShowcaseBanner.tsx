...
const candleHighlights = [
  {
    title: "Custom Candle Product Boxes",
    subtitle: "Auto-Lock & Tuck End Boxes",
    image: "/candle/candle_boxes.png",
    tag: "Heavy Duty",
    description: "Reinforced folding cartons and auto-lock bottom boxes tailored to hold heavy glass candle jars securely.",
  },
  {
    title: "Luxury Rigid Candle Gift Sets",
    subtitle: "Magnetic Boxes & Rigid Tubes",
    image: "/candle/candle_luxury_rigid.png",
    tag: "Luxury Finish",
    description: "Premium velvet-lined rigid chipboard boxes and round cylinder tubes featuring foil stamping & spot UV.",
  },
  {
    title: "Protective Inserts & Packing Paper",
    subtitle: "EVA Foam, Pulp & Printed Tissue",
    image: "/candle/candle_inserts_paper.png",
    tag: "Breakage Protection",
    description: "Precision EVA foam inserts, eco-friendly molded pulp, and custom printed tissue wrapping paper for safe transit.",
  },
  {
    title: "Heat & Wax Resistant Labels",
    subtitle: "Foil Stamped & Safety Stickers",
    image: "/candle/candle_labels_stickers.png",
    tag: "Heat & Wax Proof",
    description: "Waterproof vinyl labels and warning stickers engineered to withstand heat, wax oils, and moisture.",
  },
];

export default function CandleShowcaseBanner() {
  return (
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider bg-[#277a4e]/10 text-[#277a4e] mb-3">
              ...
              CANDLE PACKAGING RANGE
            </span>
            <h2 className="font-poppins text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#0f172a] tracking-tight leading-tight">
              Packaging Built Specifically for Candle Brands & Crafters
            </h2>
            <p className="text-gray-600 text-sm sm:text-base mt-2 leading-relaxed">
              Explore custom candle packaging styles crafted to keep glass jars safe, provide premium unboxing, and elevate your candle business.
            </p>
          </div>
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 p-4 sm:p-6 bg-white rounded-2xl border border-gray-200/80 shadow-2xs">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500">Ideal for candle makers & brands</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#0f172a]">Heat Resistant & Eco Friendly</h4>
              <p className="text-[11px] text-gray-500">Sturdy & recyclable materials</p>
            </div>
          </div>
        </div>
