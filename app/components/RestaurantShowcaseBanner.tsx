...
const restaurantHighlights = [
  {
    title: "Custom Pizza & Takeout Boxes",
    subtitle: "Pizza Boxes & Clamshells",
    image: "/restaurant/restaurant_pizza_takeout.jpg",
    tag: "Heat-Retaining",
    description: "Sturdy corrugated pizza boxes and hinged clamshell containers engineered to lock in heat and freshness.",
  },
  {
    title: "Eco Biodegradable Containers",
    subtitle: "Cornstarch & Sugarcane Containers",
    image: "/restaurant/restaurant_biodegradable.jpg",
    tag: "100% Eco-Friendly",
    description: "Compostable, renewable sugarcane bagasse and cornstarch takeout containers for sustainable dining.",
  },
  {
    title: "Beverage Carriers & Paper Cups",
    subtitle: "Multi-Compartment Carriers & Soup Bowls",
    image: "/restaurant/restaurant_beverage_cups.jpg",
    tag: "Spill-Proof",
    description: "Heavy-duty paper drink carriers, insulated coffee cups, and round soup bowls built for delivery ease.",
  },
  {
    title: "Branded Paper Bags & Sleeves",
    subtitle: "Takeout Bags, Wraps & Custom Stickers",
    image: "/restaurant/restaurant_bags_sleeves.jpg",
    tag: "Brand Elevation",
    description: "Custom printed SOS bags, greaseproof food wrap paper, heat-resistant sleeves, and tamper-evident labels.",
  },
];

export default function RestaurantShowcaseBanner() {
  return (
    <section className="bg-gradient-to-b from-white via-[#f4f9f6] to-[#f8f9fb] py-12 sm:py-16 border-b border-gray-200/60 font-inter">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10">
          <div className="max-w-2xl">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider bg-[#277a4e]/10 text-[#277a4e] mb-3">
              ...
              RESTAURANT & FOOD PACKAGING RANGE
            </span>
            <h2 className="font-poppins text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#0f172a] tracking-tight leading-tight">
              Food-Safe Takeout Packaging Crafted for Restaurants & Food Chains
            </h2>
            <p className="text-gray-600 text-sm sm:text-base mt-2 leading-relaxed">
              Explore greaseproof pizza boxes, eco-friendly sugarcane clamshells, custom drink carriers, food wraps, and tamper-evident stickers designed to protect meal quality during delivery.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {restaurantHighlights.map((item, idx) => (
            <div
              key={idx}
        ...
        <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4 p-4 sm:p-6 bg-white rounded-2xl border border-gray-200/80 shadow-2xs">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#0f172a]">5-7 Days Turnaround</h4>
              <p className="text-[11px] text-gray-500">Fast delivery for food businesses</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#0f172a]">Low MOQ Options</h4>
              <p className="text-[11px] text-gray-500">Custom orders starting at 100 units</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] text-gray-500">Visual proof before production</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="text-xs font-bold text-[#0f172a]">FDA Food-Grade Certified</h4>
              <p className="text-[11px] text-gray-500">Greaseproof & eco-friendly</p>
            </div>
          </div>
        </div>
