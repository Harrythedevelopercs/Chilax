    ...
    features: [
      {
        ...
        icon: (
          <svg className="w-7 h-7 text-[#02c074]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
          <div>
            <h2 className="font-poppins font-bold text-2xl sm:text-3xl md:text-[2rem] text-[#111827] tracking-tight leading-tight">
              ...
              <span
                className={`text-[#02c074] inline-block transition-all duration-300 ${
          ...
          <div className="flex items-center gap-2 self-end sm:self-auto flex-shrink-0">
            <button
              ...
              className="w-10 h-10 rounded-full border border-gray-200 bg-white flex items-center justify-center text-gray-600 hover:border-[#02c074] hover:text-[#02c074] hover:shadow-sm transition-all cursor-pointer"
            >
              ...
              {slides.map((_, i) => (
                <button
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    currentSlide === i ? "w-6 bg-[#02c074]" : "w-2 bg-gray-200 hover:bg-gray-300"
                  }`}
        ...
        >
          {activeSlide.features.map((feat, idx) => (
            ...
            >
              ...
              <div className="w-14 h-14 rounded-2xl bg-[#e8f5ee] flex items-center justify-center flex-shrink-0">
                {feat.icon}
              </div>
